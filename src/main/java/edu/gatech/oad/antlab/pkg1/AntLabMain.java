 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Austin Joyner");
		  toPrint += p1.toString("ajoyner3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Sean Collins");
		  toPrint += p2.toString("scollins36");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Porter Rivers");
		  toPrint += p3.toString("privers6");
          //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("jbrown72");
          toPrint += p4.toString("Jeremy Brown");
          //Person5 replace P4 with your name
          //and gburdell5 with your gt id
          Person5 p5 = new Person5("Nikhil Harithas");
          toPrint += p5.toString("nharithas3");
